...
(function () {
    ...
    Cluster.prototype.updateClusterMarker = function () {
        ...
        this._clusterMarker.addEventListener("click", function (event) {
            ...
            filterViewport(thatMap,thatBounds);
        });

    };
    //过滤反复调用setViewport，只调用一次
    var _filterViewportHandler=null;
    function filterViewport(map,thatBounds){
         clearTimeout(_filterViewportHandler);
        _filterViewportHandler=setTimeout(function () {
            map.setViewport(thatBounds);
        },100);
    }
    /**
     * 删除该聚合。
